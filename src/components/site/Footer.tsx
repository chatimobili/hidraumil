        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="https://www.facebook.com/hidraumilhidraulicos" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className={socialClass}><Facebook className="h-5 w-5" /></a>
            </div>
          </div>
        </div>
