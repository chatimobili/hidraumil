  ...
  return (
    <div className="fixed bottom-20 right-5 z-50 group">
      ...
      <div className="relative h-14 w-14">
        ...
        <span className="absolute inset-0 rounded-full bg-[#25D366] opacity-60 wa-pulse pointer-events-none" />
        <span
          className="absolute inset-0 rounded-full bg-[#25D366] opacity-40 wa-pulse pointer-events-none"
        ...
        <a
          ...
          className="relative z-10 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl shadow-[#25D366]/40 hover:scale-110 active:scale-95 transition-transform duration-300 wa-float-in"
        >
          {/* Online indicator */}
          ...
          <svg viewBox="0 0 32 32" className="h-7 w-7 drop-shadow" fill="currentColor" aria-hidden="true">
