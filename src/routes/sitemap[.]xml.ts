...
const BASE_URL = "https://hidraumil.com.br";
    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/blog/assistencia-tecnica-paleteira-cascavel", changefreq: "monthly", priority: "0.7" },
          { path: "/blog/pecas-paleteira-hidraulica-cascavel", changefreq: "monthly", priority: "0.7" },
          { path: "/blog/paleteira-industria-alimentos-cascavel", changefreq: "monthly", priority: "0.7" },
          { path: "/blog/paleteira-2000kg-vs-3000kg-cascavel", changefreq: "monthly", priority: "0.7" },
          { path: "/blog/seguranca-operacao-paleteira-cascavel", changefreq: "monthly", priority: "0.7" },
          { path: "/blog/oleo-hidraulico-paleteira-cascavel", changefreq: "monthly", priority: "0.7" },
          { path: "/blog/paleteira-cooperativas-oeste-parana", changefreq: "monthly", priority: "0.7" },
