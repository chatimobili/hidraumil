...
export const Route = createFileRoute("/manutencao-paleteira-hidraulica-marechal-candido-rondon")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "/manutencao-paleteira-hidraulica-marechal-candido-rondon" },
      { property: "og:type", content: "website" },
    ],
    links: [{ rel: "canonical", href: "/manutencao-paleteira-hidraulica-marechal-candido-rondon" }],
  }),
